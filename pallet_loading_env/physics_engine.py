...
class PhysicsStabilityEngine():
    ...
    def run_stability_simulation(self, num_steps=200, tol=0.1):
        ...
        parcel_stabiltiy_score = self.check_stability(orginal_parcel_pos, final_parcel_pos, tol=tol)

        # calculate stability score
        stability_score = np.sum(parcel_stabiltiy_score) / len(self.parcel_ids)
